...
<nav class="side-navbar shrink">
    <span class="brand-big">
        ...
        <a href="{{url('/')}}"><img src="{{asset('/logo/20230730035659.png')}}" width="115"></a>
        @else
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group">
                                          <input type="text" id="reference-no" name="reference_no" class="form-control" placeholder="Ketik Nomor Referensi" onkeyup='saveValue(this);'/>
                                      </div>
